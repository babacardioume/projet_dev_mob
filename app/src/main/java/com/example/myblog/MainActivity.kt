...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mydb: DBSQLiteHelper
    private lateinit var posts: List<Affichages>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        baseline_add.setOnClickListener {
            val intent = Intent(this@MainActivity, AjoutBlog::class.java)
            startActivity(intent)
        }
    }
